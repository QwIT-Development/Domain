...
INSERT INTO "new_User" ("banMessage", "banned", "bondLvl", "id", "msgCount", "muteCount", "repPoint", "totalMsgCount") SELECT "banMessage", "banned", "bondLvl", "id", "msgCount", "muteCount", "repPoint", "totalMsgCount" FROM "User";
DROP TABLE "User";
