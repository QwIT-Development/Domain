...
module.exports = {
    ...
    async execute(interaction) {
        ...
        content += state.strings.reputation.percent100.replace("{SCORE}", (1000 - score).toString());
        content += state.strings.reputation.currentPercent.replace("{SCORE}", Math.floor((score / 1000) * 100).toString());
